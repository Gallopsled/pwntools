...
>>> payload = str(fileStr)
>>> payload
''
...
def update_var(l):
    ...
    Examples:
        ...
        >>> update_var(8)
        {'_flags2': 4, '_IO_backup_base': 8, 'chain': 8, '_IO_read_end': 8, '_old_offset': 8, '_wide_data': 8, '_IO_buf_end': 8, '_vtable_offset': 1, '_IO_save_base': 8, '_IO_read_base': 8, '_shortbuf': 1, '_lock': 8, '_IO_write_ptr': 8, 'markers': 8, 'unknown2': 48, 'unknown1': 4, 'vtable': 8, '_IO_write_end': 8, '_codecvt': 8, '_cur_column': 2, 'fileno': 4, '_IO_write_base': 8, '_IO_save_end': 8, '_offset': 8, 'flags': 8, '_IO_read_ptr': 8, '_IO_buf_base': 8}
    """
    var={}
    for i in variables:
...
def packit(s,l=8):
    r"""
    Different members of the file structure have different sizes. While packing them together, we need to pack them based on their sizes. This function helps do that.

    Arguments:
        s(int)
            The value that is to be packed.
        l(int)
            The length of the field that is to be packed. For example, packit(s,8) works like p64() in pwntools.

    Examples:

        To pack the value `0xfacef00d` as 8 byte value (eqivalent to p64(0xfacef00d))

        >>> packit(0xfacef00d,8)
        '\r\xf0\xce\xfa\x00\x00\x00\x00'

        To pack the value `0xfacef00d` as 4 byte value (eqivalent to p32(0xfacef00d))
...
class FileStructure(object):
    ...
    Examples:
        ...
        >>> payload = str(fileStr)
        >>> payload
        '\r\r\x00\x00\x00\xff\xff\xff\xff\xff\xff\xff\xff\x00\x00\x00\x00\x00\x00\x00\x00\xef\xee\xdb\xea\r\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'
    ...
    def __init__(self,null=0):
            ...
            if context.arch=='i386':
                ...
                log.error("Sorry! Architecture is not supported.")
    ...
    def __str__(self):
        ...
        for val in self.vars_:
            if isinstance(self.__getattr__(val),str):
                if context.arch=='i386':
                    structure+=self.__getattr__(val).ljust(4,'\x00')
                elif context.arch=='amd64':
                    structure+=self.__getattr__(val).ljust(8,'\x00')
            else:
                structure+=packit(self.__getattr__(val),self.length[val])
        return structure
    ...
    def write(self,addr=0,size=0):
        ...
        Example:
            ...
            >>> payload
            '\x00\x08\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xbe\xba\xfe\xca\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xbe\xba\xfe\xca\x00\x00\x00\x00"'
        """
        self.flags &=~8
        self.flags |=0x800
    ...
    def read(self,addr=0,size=0):
        ...
        Example:
            ...
            >>> payload
            '"\xbb\xfe\xca\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'
        """
        self.flags &=~4
        self._IO_read_base = 0
        self._IO_read_ptr = 0
    ...
    def orange(self,io_list_all,vtable):
        ...
        Example:
            ...
            >>> payload
            '/bin/sh\x00a'
        """
