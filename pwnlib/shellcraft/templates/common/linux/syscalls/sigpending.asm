...
%>
<%docstring>sigpending(vararg_0, vararg_1, vararg_2, vararg_3, vararg_4) -> str
...
<%
    ...
    for syscall in ['SYS_rt_sigpending']:
        if hasattr(pwnlib.constants, syscall):
            break
    else:
        raise Exception("Could not locate any syscalls: %r" % syscalls)
%>
    /* sigpending(vararg_0=${repr(vararg_0)}, vararg_1=${repr(vararg_1)}, vararg_2=${repr(vararg_2)}, vararg_3=${repr(vararg_3)}, vararg_4=${repr(vararg_4)}) */
