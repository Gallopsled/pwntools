...
%>
    /* mq_open(name=${repr(name)}, oflag=${repr(oflag)}, vararg_0=${repr(vararg_0)}, vararg_1=${repr(vararg_1)}, vararg_2=${repr(vararg_2)}, vararg_3=${repr(vararg_3)}, vararg_4=${repr(vararg_4)}) */
