...
%>
<%docstring>fadvise(vararg_0, vararg_1, vararg_2, vararg_3, vararg_4) -> str

Invokes the syscall fadvise.

See 'man 2 fadvise' for more information.
...
<%
    ...
    for syscall in ['SYS_fadvise']:
        if hasattr(pwnlib.constants, syscall):
            break
    else:
        raise Exception("Could not locate any syscalls: %r" % syscalls)
%>
    /* fadvise(${', '.join(syscall_repr)}) */
