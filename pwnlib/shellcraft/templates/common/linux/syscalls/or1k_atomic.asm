...
%>
<%docstring>or1k_atomic(vararg_0, vararg_1, vararg_2, vararg_3, vararg_4) -> str

Invokes the syscall or1k_atomic.

See 'man 2 or1k_atomic' for more information.
...
<%
    ...
    for syscall in ['SYS_or1k_atomic']:
        if hasattr(pwnlib.constants, syscall):
            break
    else:
        raise Exception("Could not locate any syscalls: %r" % syscalls)
%>
    /* or1k_atomic(${', '.join(syscall_repr)}) */
