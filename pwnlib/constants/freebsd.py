...
MINCORE_SUPER = Constant('MINCORE_SUPER', 0x20)
...
RFTSIGMASK = Constant('RFTSIGMASK', 0xF)
...
SF_SETTABLE = Constant('SF_SETTABLE', 0xf)
...
SOL_SOCKET = Constant('SOL_SOCKET', 0xf)
...
UF_SETTABLE = Constant('UF_SETTABLE', 0x0000)
...
_POSIX_VDISABLE = Constant('_POSIX_VDISABLE', 0xf)
