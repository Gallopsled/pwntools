...
PTRACE_GETSIGMASK = Constant('PTRACE_GETSIGMASK', 0x420a)
PTRACE_SETSIGMASK = Constant('PTRACE_SETSIGMASK', 0x420b)
PTRACE_SECCOMP_GET_FILTER = Constant('PTRACE_SECCOMP_GET_FILTER', 0x420c)
PTRACE_SECCOMP_GET_METADATA = Constant('PTRACE_SECCOMP_GET_METADATA', 0x420d)
PTRACE_GET_SYSCALL_INFO = Constant('PTRACE_GET_SYSCALL_INFO', 0x420e)
PTRACE_GET_RSEQ_CONFIGURATION = Constant('PTRACE_GET_RSEQ_CONFIGURATION', 0x420f)
...
PTRACE_O_MASK = Constant('PTRACE_O_MASK',0x003000ff)
