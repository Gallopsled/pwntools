...
class FileStructure:
    ...
    def struntil(self,v):
        ...
        Example:
            ...
            The returned payload includes the whole of the final field ``v``, so its
            length is the sum of the field sizes up to and including ``v``:

            >>> len(fileStr.struntil("flags"))
            8
            >>> len(fileStr.struntil("_IO_buf_end"))
            72
        """
    ...
    def write(self,addr=0,size=0):
        ...
        Example:
            ...
            >>> payload
            b'\x00\x08\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xbe\xba\xfe\xca\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xbe\xba\xfe\xca\x00\x00\x00\x00"'
        """
    ...
    def read(self,addr=0,size=0):
        ...
        Example:
            ...
            >>> payload
            b'"\xbb\xfe\xca\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'
        """
