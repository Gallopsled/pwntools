...
all_crcs = \
    {'arc': {'check': 47933,
             'init': 0,
             'link': 'https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat-bits.16',
             'name': 'arc',
             'poly': 32773,
             'refin': True,
             'refout': True,
     ...
     'crc_10': {'check': 409,
                'init': 0,
                'link': 'https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat-bits.10',
                'name': 'crc_10',
                'poly': 563,
                'refin': False,
                'refout': False,
     ...
     'crc_11': {'check': 1443,
                'init': 26,
                'link': 'https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat-bits.11',
                'name': 'crc_11',
                'poly': 901,
                'refin': False,
                'refout': False,
     ...
     'crc_12_cdma2000': {'check': 3405,
                         'init': 4095,
                         'link': 'https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat-bits.12',
     ...
     'crc_13_bbc': {'check': 1274,
                    'init': 0,
                    'link': 'https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat-bits.13',
                    'name': 'crc_13_bbc',
                    'poly': 7413,
                    'refin': False,
                    'refout': False,
     ...
     'crc_14_darc': {'check': 2093,
                     'init': 0,
                     'link': 'https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat-bits.14',
                     'name': 'crc_14_darc',
                     'poly': 2053,
                     'refin': True,
                     'refout': True,
     ...
     'crc_15': {'check': 1438,
                'init': 0,
                'link': 'https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat-bits.15',
                'name': 'crc_15',
                'poly': 17817,
                'refin': False,
                'refout': False,
     ...
     'crc_16_aug_ccitt': {'check': 58828,
                          'init': 7439,
                          'link': 'https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-16-aug-ccitt',
     ...
     'crc_16_buypass': {'check': 65256,
                        'init': 0,
                        'link': 'https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-16-buypass',
                        'name': 'crc_16_buypass',
                        'poly': 32773,
                        'refin': False,
                        'refout': False,
     ...
     'crc_16_ccitt_false': {'check': 10673,
                            'init': 65535,
                            'link': 'https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-16-ccitt-false',
     ...
     'crc_16_maxim': {'check': 17602,
                      'init': 0,
                      'link': 'https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-16-maxim',
                      'name': 'crc_16_maxim',
                      'poly': 32773,
                      'refin': True,
                      'refout': True,
     ...
     'crc_24': {'check': 2215682,
                'init': 11994318,
                'link': 'https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat-bits.24',
                'name': 'crc_24',
                'poly': 8801531,
                'refin': False,
                'refout': False,
     ...
     'crc_30_cdma': {'check': 79907519,
                     'init': 1073741823,
                     'link': 'https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat-bits.30',
                     'name': 'crc_30_cdma',
                     'poly': 540064199,
                     'refin': False,
                     'refout': False,
     ...
     'crc_31_philips': {'check': 216654956,
                        'init': 2147483647,
                        'link': 'https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat-bits.31',
                        'name': 'crc_31_philips',
                        'poly': 79764919,
                        'refin': False,
                        'refout': False,
     ...
     'crc_32': {'check': 3421780262,
                'init': 4294967295,
                'link': 'https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat-bits.32',
                'name': 'crc_32',
                'poly': 79764919,
                'refin': True,
                'refout': True,
     ...
     'crc_32_posix': {'check': 1985902208,
                      'init': 0,
                      'link': 'https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-32-posix',
                      'name': 'crc_32_posix',
                      'poly': 79764919,
                      'refin': False,
                      'refout': False,
     ...
     'crc_32c': {'check': 3808858755,
                 'init': 4294967295,
                 'link': 'https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-32c',
                 'name': 'crc_32c',
                 'poly': 517762881,
                 'refin': True,
                 'refout': True,
     ...
     'crc_32d': {'check': 2268157302,
                 'init': 4294967295,
                 'link': 'https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-32d',
                 'name': 'crc_32d',
                 'poly': 2821953579,
                 'refin': True,
                 'refout': True,
     ...
     'crc_32q': {'check': 806403967,
                 'init': 0,
                 'link': 'https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-32q',
                 'name': 'crc_32q',
                 'poly': 2168537515,
                 'refin': False,
                 'refout': False,
     ...
     'crc_3_gsm': {'check': 4,
                   'init': 0,
                   'link': 'https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat-bits.3',
                   'name': 'crc_3_gsm',
                   'poly': 3,
                   'refin': False,
                   'refout': False,
     ...
     'crc_40_gsm': {'check': 910907393606,
                    'init': 0,
                    'link': 'https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat-bits.40',
                    'name': 'crc_40_gsm',
                    'poly': 75628553,
                    'refin': False,
                    'refout': False,
     ...
     'crc_4_interlaken': {'check': 11,
                          'init': 15,
                          'link': 'https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat-bits.4',
     ...
     'crc_4_itu': {'check': 7,
                   'init': 0,
                   'link': 'https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-4-itu',
                   'name': 'crc_4_itu',
                   'poly': 3,
                   'refin': True,
                   'refout': True,
     ...
     'crc_5_epc': {'check': 0,
                   'init': 9,
                   'link': 'https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat-bits.5',
                   'name': 'crc_5_epc',
                   'poly': 9,
                   'refin': False,
                   'refout': False,
     ...
     'crc_5_itu': {'check': 7,
                   'init': 0,
                   'link': 'https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-5-itu',
                   'name': 'crc_5_itu',
                   'poly': 21,
                   'refin': True,
                   'refout': True,
     ...
     'crc_64': {'check': 7800480153909949255,
                'init': 0,
                'link': 'https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat-bits.64',
                'name': 'crc_64',
     ...
     'crc_6_cdma2000_a': {'check': 13,
                          'init': 63,
                          'link': 'https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat-bits.6',
     ...
     'crc_6_itu': {'check': 6,
                   'init': 0,
                   'link': 'https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-6-itu',
                   'name': 'crc_6_itu',
                   'poly': 3,
                   'refin': True,
                   'refout': True,
     ...
     'crc_7': {'check': 117,
               'init': 0,
               'link': 'https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat-bits.7',
               'name': 'crc_7',
               'poly': 9,
               'refin': False,
               'refout': False,
     ...
     'crc_8': {'check': 244,
               'init': 0,
               'link': 'https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat-bits.8',
               'name': 'crc_8',
               'poly': 7,
               'refin': False,
               'refout': False,
     ...
     'crc_82_darc': {'check': 749237524598872659187218,
                     'init': 0,
                     'link': 'https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat-bits.82',
                     'name': 'crc_82_darc',
     ...
     'crc_8_ebu': {'check': 151,
                   'init': 255,
                   'link': 'https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-8-ebu',
                   'name': 'crc_8_ebu',
                   'poly': 29,
                   'refin': True,
                   'refout': True,
     ...
     'crc_8_itu': {'check': 161,
                   'init': 0,
                   'link': 'https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-8-itu',
                   'name': 'crc_8_itu',
                   'poly': 7,
                   'refin': False,
                   'refout': False,
     ...
     'crc_8_maxim': {'check': 161,
                     'init': 0,
                     'link': 'https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-8-maxim',
                     'name': 'crc_8_maxim',
                     'poly': 49,
                     'refin': True,
                     'refout': True,
     ...
     'crc_a': {'check': 48901,
               'init': 50886,
               'link': 'https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-a',
               'name': 'crc_a',
               'poly': 4129,
               'refin': True,
               'refout': True,
     ...
     'jamcrc': {'check': 873187033,
                'init': 4294967295,
                'link': 'https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.jamcrc',
                'name': 'jamcrc',
                'poly': 79764919,
                'refin': True,
                'refout': True,
     ...
     'kermit': {'check': 8585,
                'init': 0,
                'link': 'https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.kermit',
                'name': 'kermit',
                'poly': 4129,
                'refin': True,
                'refout': True,
     ...
     'modbus': {'check': 19255,
                'init': 65535,
                'link': 'https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.modbus',
                'name': 'modbus',
                'poly': 32773,
                'refin': True,
                'refout': True,
     ...
     'x_25': {'check': 36974,
              'init': 65535,
              'link': 'https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.x-25',
              'name': 'x_25',
              'poly': 4129,
              'refin': True,
              'refout': True,
     ...
     'xfer': {'check': 3171672888,
              'init': 0,
              'link': 'https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.xfer',
              'name': 'xfer',
              'poly': 175,
              'refin': False,
              'refout': False,
     ...
     'xmodem': {'check': 12739,
                'init': 0,
                'link': 'https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.xmodem',
                'name': 'xmodem',
                'poly': 4129,
                'refin': False,
                'refout': False,
