...
class Progress:
    ...
    """
    def __init__(self, logger: Logger, msg: str, status: str, level: int, args: tuple[Any], kwargs: dict[str, Any]) -> None:
        self._logger = logger
        self._msg = msg
        self._status = status
        self._level = level
    ...
    def _log(self, status: object, args: tuple[Any], kwargs: dict[str, Any], msgtype: str) -> None:
    ...
    def success(self, status: object = 'Done', *args: Any, **kwargs: Any) -> None:
    ...
    def failure(self, status: object = 'Failed', *args: Any, **kwargs: Any) -> None:
        """failure(message)
    ...
    def __exit__(self, exc_typ: type[BaseException], exc_val: BaseException, exc_tb: TracebackType | None) -> None:
...
class Logger:
    ...
    * :meth:`warning_once` (alias :meth:`warn_once`)
    ...
    def _getlevel(self, levelString: str | int) -> int:
        if isinstance(levelString, int):
            return levelString
        return logging._nameToLevel[levelString.upper()]
        

    def _log(self, level: int, msg: object, args: tuple[Any], kwargs: dict[str, Any], msgtype: str | None, progress: Progress | None = None):
        # Logs are strings, not bytes.  Handle Python3 bytes() objects.
        msg = _need_text(msg)
    ...
    def indented(self, message: object, *args: Any, **kwargs: Any) -> None:
    ...
    def failure(self, message: object, *args: Any, **kwargs: Any) -> None:
    ...
    def warn_once(self, *args: Any, **kwargs: Any) -> None:
    ...
    def hexdump(self, message: bytes, *args: Any, **kwargs: Any) -> None:
    ...
    def maybe_hexdump(self, message: bytes, *args: Any, **kwargs: Any) -> None:
    ...
    def error(self, message: object, *args: Any, **kwargs: Any) -> NoReturn:
        ...
        """
        msg = _need_text(message)
        self._log(logging.ERROR, msg, args, kwargs, 'error')
        raise PwnlibException(msg % args)

    def exception(self, message: object, *args: Any, **kwargs: Any) -> NoReturn:
...
class Formatter(logging.Formatter):
    ...
    * If the message spans multiple lines they are split, and all subsequent
    ...
    def format(self, record: logging.LogRecord) -> str:
        ...
        msgtype: str | None = getattr(record, 'pwnlib_msgtype', None)
...
def _need_text(s: object) -> str:
    # circular import wrapper
    global _need_text
    from pwnlib.util.packing import _need_text as real_need_text
    _need_text = real_need_text
    return real_need_text(s, 2)
...
class LogfileHandler(logging.FileHandler):
    def __init__(self):
        super(LogfileHandler, self).__init__('', delay=True)
    @property
    ...
    def handle(self, record: logging.LogRecord) -> bool:
        if self.stream.name is not None:
            return super(LogfileHandler, self).handle(record)
        return False
