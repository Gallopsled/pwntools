...
def asciify_shellcode(shellcode, slop, vocab = None):
    ...
    Examples:
        ...
        >>> print(bytes2hex(asciify_shellcode(sc, 300, arch='i386')))
...
def _get_allocator(slop, vocab):
    ...
    Examples:
        ...
        >>> vocab = hex2bytes('2122232425262728292a2b2c2d2e2f303132333435363738393a3b3c3d3e3f404142434445464748494a4b4c4d4e4f505152535455565758595a5b5c5d5e5f606162636465666768696a6b6c6d6e6f707172737475767778797a7b7c7d7e')
        >>> print(bytes2hex(_get_allocator(300, vocab, arch='i386')))
...
def _get_subtractions(shellcode, vocab):
    ...
    Examples:
        ...
        >>> sc = hex2bytes('414243444546474849474b4c4d4e4f5051525354555658595a')
        >>> vocab = hex2bytes('2122232425262728292a2b2c2d2e2f303132333435363738393a3b3c3d3e3f404142434445464748494a4b4c4d4e4f505152535455565758595a5b5c5d5e5f606162636465666768696a6b6c6d6e6f707172737475767778797a7b7c7d7e')
        >>> print(bytes2hex(_get_subtractions(sc, vocab, arch='i386')))
