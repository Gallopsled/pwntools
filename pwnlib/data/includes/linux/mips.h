...
#define LOCK_RW 192
#define O_TMPFILE (0o20000000 | 0x10000)
...
#define SYS_epoll_pwait (4000 + 276)
#define SYS_epoll_wait (4000 + 250)
#define SYS_eventfd (4000 + 282)
...
#define SYS_get_robust_list (4000 + 273)
...
#define SYS_ioprio_get (4000 + 278)
#define SYS_ioprio_set (4000 + 277)
#define SYS_io_setup (4000 + 241)
#define SYS_io_submit (4000 + 244)
#define SYS_ipc (4000 + 117)
#define SYS_kexec_load (4000 + 274)
...
#define SYS_set_robust_list (4000 + 272)
...
#define SYS_timerfd (4000 + 281)
#define SYS_timerfd_create (4000 + 284)
#define SYS_timerfd_gettime (4000 + 285)
#define SYS_timerfd_settime (4000 + 286)
