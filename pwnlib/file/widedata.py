...
variables={
    0:{name:'_IO_read_ptr',size:length},
    1:{name:'_IO_read_end',size:length},
    2:{name:'_IO_read_base',size:length},
    3:{name:'_IO_write_base',size:length},
    4:{name:'_IO_write_ptr',size:length},
    5:{name:'_IO_write_end',size:length},
    6:{name:'_IO_buf_base',size:length},
    7:{name:'_IO_buf_end',size:length},
    8:{name:'_IO_save_base',size:length},
    9:{name:'_IO_backup_base',size:length},
    10:{name:'_IO_save_end',size:length},
    11:{name:'_IO_state',size:8},
    12:{name:'_IO_last_state',size:8},
    13:{name:'_codecvt',size:4}, # 32b:0x48, 64b:0x70
    14:{name:'_shortbuf',size:4},
    15:{name:'_wide_vtable',size:length}
}
